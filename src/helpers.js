...
export function getWspUrl(orderData) {
  ...
  const WSP_URL = `https://api.whatsapp.com/send/?phone=${N}&text=%2A${"Orden"}%3A%2A%20${ID}%0A%0A%2A${"Cliente"}%3A%2A%20${name}%0A%0A%2A${"Celular"}%3A%2A%20${phone}%0A%0A%2A${
  ...
  }${comment ? "Commentario" + "%3A%2A%20" + comment + "%0A%0A%2A" : ""}${"Mi Pedido"}%3A%2A${cartListforUrl}%0A%0A%2A${
